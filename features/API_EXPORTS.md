...
- src/lib/main.js must export named functions hammingDistanceString and hammingDistanceBits.
- No default export should be relied upon by public consumers for these core functions.
- Update README with example import lines that use named imports from src/lib/main.js and show simple usage examples for both string and bit Hamming functions.

Acceptance Criteria

- src/lib/main.js exports hammingDistanceString and hammingDistanceBits as named exports.
